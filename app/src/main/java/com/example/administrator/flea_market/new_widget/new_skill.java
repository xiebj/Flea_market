...
public class new_skill extends Activity {
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (imageItem.size() == 4 && position == 0) { //第一张为默认图片
                    Toast.makeText(new_skill.this, "图片数3张已满", Toast.LENGTH_SHORT).show();
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(new_skill.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_new_skill, menu);
        return true;
    }
