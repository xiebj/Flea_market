...
public class detial_info extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        query.getObject(this, object_id, new GetListener<MyGoods>() {
            @Override
            public void onSuccess(MyGoods object) {
                ...
                DisplayImageOptions options = new DisplayImageOptions.Builder()//
                        ...
                        .cacheOnDisk(true) //
                        .build();//
                ImageLoader.getInstance().displayImage(object.getAuthor().getAvator().getFileUrl(detial_info.this), head_pic, options);
        ...
        query_comment.findObjects(this, new FindListener<Comment>() {
            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.chat_btn:
                ...
                info = new BmobIMUserInfo(post.getAuthor().getObjectId(),post.getAuthor().getName(),post.getAuthor().getAvator().getFileUrl(detial_info.this));
    ...
    public void sendComment() {
        if (comment_content.getText().toString().equals("")) {
            ...
            MyUser user = BmobUser.getCurrentUser(detial_info.this, MyUser.class);
